---
title: "Mplexia Limited | AWS Cloud Network Consulting"
description: "AWS Cloud Network Consulting • Terraform Expert • GitOps • Global Multi-Region Architectures"
layout: page
---
...
{{< button href="https://calendly.com/lrozehnal" target="_blank" >}}
...
### Global AWS Networking Architecture
Expert design and implementation of scalable AWS global networks using Transit Gateway, Direct Connect, VPN solutions, multi-region hub-and-spoke or meshed topologies, security hardening, low-latency optimization, and multicast. Specialized support for upgrading and modernizing current architectures.

### Cloud Migration & Automation</h3>
Helping organizations with connectivity aspects of on-premise to AWS hybrid migrations, introducing or utilizing existing automation (Terraform, Ansible, Python), security hardening and resilience engineering. Helping overcome initial hurdles when introducing cloud automation (Terraform).

### AWS Connectivity Consulting & Delivery
...
**Senior DevOps / Cloud Network Specialist (UK Remote)**

- Led flagship 2024–2025 project: complete Terraform + GitOps automation of global multi-region AWS network connectivity
- Delivered zero manual console changes in production for all networking and infrastructure
- Architected resilient Transit Gateway and hub-and-spoke topologies for low-latency trading workloads
- Multicast in AWS, Dynamic propagation of static routes between Transit Gateways, onboarding of various projects of all kinds and sizes
...
*Mplexia Limited (UK) • VAT registered if required • Fully remote*

## Ready to discuss your next AWS networking project?

I work selectively with MSPs, VARs and AWS-heavy organisations on 3–12 month engagements or advisory work.
